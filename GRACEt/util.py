...
def get_parameter(args):
    ...
    setting = 'public'
    args.wd1 = float(config[setting]['Cora']['wd1'])
    args.wd2 = float(config[setting]['Cora']['wd2'])
    args.wd3 = float(config[setting]['Cora']['wd3'])
    args.lr1 = float(config[setting]['Cora']['lr1'])
    args.lr2 = float(config[setting]['Cora']['lr2'])
    args.lr3 = float(config[setting]['Cora']['lr3'])
    args.l1 = float(config[setting]['Cora']['l1'])
    args.l2 = float(config[setting]['Cora']['l2'])
    args.l3 = float(config[setting]['Cora']['l3'])
    args.l4 = float(config[setting]['Cora']['l4'])
    args.num_epochs = config[setting]['Cora']['num_epochs']
    return args
